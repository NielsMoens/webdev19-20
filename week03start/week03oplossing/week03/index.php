...
<section>
    <form method="POST" action="/week03/upload.php" enctype="multipart/form-data">
                            ...
                            <div class="file">
                                <?php if( file_is_image($file_extension) ) : ?>
                                    <div class="icon icon-image">
                                        <img src="/week03/<?php echo $item_path; ?>">
                                    </div>
                                <?php else : ?>
                                ...
                                <?php if( file_is_text($file_extension) ) : ?>
                                    <a href="/week03/edit.php?file=<?php echo $item_path; ?>" class="btn">Edit</a>
                                <?php endif; ?>
                                    <a href="/week03/<?php echo $item_path; ?>" class="btn" download>Download</a>
                                </div>
                            </div> 
                        <?php
                    }
